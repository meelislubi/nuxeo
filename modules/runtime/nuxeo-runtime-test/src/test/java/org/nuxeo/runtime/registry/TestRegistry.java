...
public class TestRegistry {
    ...
    public void testCompatWarnMapRegistry() throws Exception {
        ...
        assertEquals(
                "The contribution with id 'sample1' has been implicitely merged: the compatibility mechanism on its"
                        + " descriptor class 'org.nuxeo.runtime.registry.SampleWarnOnMergeDescriptor' detected it, and"
